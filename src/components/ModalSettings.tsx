          ...
          <form>
            <div className="grid grid-cols-3 gap-5 justify-normal">
              ...
              <div className="form-group ">
                <label className="block mb-3 text-sm font-medium text-black dark:text-white" htmlFor="para">
                  Parameter
                </label>
              ...
              <div className="form-group">
                <label className="block mb-3 text-sm font-medium text-black dark:text-white" htmlFor="criterion">
                  Criterion
                </label>
                <div className="relative z-20 w-full rounded border border-stroke p-1.5 pr-8 font-medium outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                  <div className="flex flex-wrap items-center"></div>
              ...
              <div className="w-full form-group">
                <label className="block mb-3 text-sm font-medium text-black dark:text-white" htmlFor="value">
                  Value to give Alert
                </label>
                <input
                  className="w-full rounded border border-stroke bg-gray py-3 pl-3 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
              ...
              <div className="form-group">
                <label className="block mb-3 text-sm font-medium text-black dark:text-white" htmlFor="type">
                  Alert Type
                </label>
                <div className="relative z-20 w-full rounded border border-stroke p-1.5 pr-8 font-medium outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                  <div className="flex flex-wrap items-center"></div>
