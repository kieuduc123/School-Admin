...
import { setLocalStorageItem } from 'src/utils/storage/local-storage'
const SignIn = () => {
  ...
  const handleLogin = async (values: any) => {
    try {
      ...
      dispatch(setIsLogin(response?.data?.userDetail))
      setLocalStorageItem(Storage.user, JSON?.stringify(response?.data?.userDetail))
      navigate('/')
