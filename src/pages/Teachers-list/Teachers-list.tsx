import React, { Button, Col, Form, Input, Row, Select, Table, Modal, DatePicker, Radio, Upload } from 'antd'
...
export default function Teachers() {
  ...
  useEffect(() => {
    ...
    axios
      .get('http://14.248.97.203:4869/api/v1/school/teacher-school-year')
      .then((response) => {
